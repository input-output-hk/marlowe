...
%token
  ...
  'Case'              { PT _ (TS _ 10) }
  'Choice'            { PT _ (TS _ 11) }
  'ChoiceId'          { PT _ (TS _ 12) }
  'ChoiceValue'       { PT _ (TS _ 13) }
  'ChoseSomething'    { PT _ (TS _ 14) }
  'Close'             { PT _ (TS _ 15) }
  'Cond'              { PT _ (TS _ 16) }
  'Constant'          { PT _ (TS _ 17) }
  'Deposit'           { PT _ (TS _ 18) }
  'DivValue'          { PT _ (TS _ 19) }
  'FalseObs'          { PT _ (TS _ 20) }
  'If'                { PT _ (TS _ 21) }
  'Let'               { PT _ (TS _ 22) }
  'MerkleizedCase'    { PT _ (TS _ 23) }
  'MulValue'          { PT _ (TS _ 24) }
  'NegValue'          { PT _ (TS _ 25) }
  'NotObs'            { PT _ (TS _ 26) }
  'Notify'            { PT _ (TS _ 27) }
  'OrObs'             { PT _ (TS _ 28) }
  'Party'             { PT _ (TS _ 29) }
  'Pay'               { PT _ (TS _ 30) }
  'Role'              { PT _ (TS _ 31) }
  'SubValue'          { PT _ (TS _ 32) }
  'TimeIntervalEnd'   { PT _ (TS _ 33) }
  'TimeIntervalStart' { PT _ (TS _ 34) }
  'Timeout'           { PT _ (TS _ 35) }
  'Token'             { PT _ (TS _ 36) }
...
Contract
  ...
  | 'When' ListCase Timeout Contract { Language.Marlowe.Syntax.AbsMarlowe.When $2 $3 $4 }
...
ListCase : {- empty -} { [] } | Case '.' ListCase { (:) $1 $3 }
...
Timeout
  : 'Timeout' Integer { Language.Marlowe.Syntax.AbsMarlowe.Timeout $2 }

Bound :: { Language.Marlowe.Syntax.AbsMarlowe.Bound }
Bound
  : Integer Integer { Language.Marlowe.Syntax.AbsMarlowe.Bound $1 $2 }

ListBound :: { [Language.Marlowe.Syntax.AbsMarlowe.Bound] }
ListBound : {- empty -} { [] } | Bound '.' ListBound { (:) $1 $3 }
...
Action
  ...
  | 'Choice' ChoiceId ListBound { Language.Marlowe.Syntax.AbsMarlowe.Choice $2 $3 }

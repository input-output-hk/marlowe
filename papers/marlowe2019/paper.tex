...
issue by moving to an energy efficient \emph{Proof of Stake} protocol.
LINK?
...
This form of implementation relies on the extensions to the UTxO model
that are described in REFERENCE TO PLUTUS WHAT???.
...
\begin{figure}[!h]
    \centering
    \includegraphics[width=1\textwidth]{figures/Marlowe3-Figures-003.jpeg}

...
and returns the next state, and \emph{POF} returns the \emph{payoff} from a state.
...
We are very grateful to Finley and Kegan McIlwaine of the University of Wyoming for their implementation of the LAM contract in ActusLabs, and to colleagues at Quanterall%\footnote{\url{https://quanterall.com/}} 

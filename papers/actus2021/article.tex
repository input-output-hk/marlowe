...
Generated contract is essentially a continuation chain of repetition
Marlowe Contracts:
...
\begin{figure}
\includegraphics[width=1\textwidth]{flowchart} \caption{Modules responsible for contract generation.}
\label{fig1-1-1} 
\end{figure}

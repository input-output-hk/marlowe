    ...
    (b "ChoiceId" 12
       (b "Address" 6
          ...
          (b "AvailableMoney" 9
             ...
             (b "Choice" 11 (b "Case" 10 N N) N)))
       (b "Deposit" 18
          (b "Close" 15
             (b "ChoseSomething" 14 (b "ChoiceValue" 13 N N) N)
             (b "Constant" 17 (b "Cond" 16 N N) N))
          (b "If" 21
             (b "FalseObs" 20 (b "DivValue" 19 N N) N) (b "Let" 22 N N))))
    (b "TimeIntervalStart" 34
       (b "Party" 29
          (b "NotObs" 26
             (b "NegValue" 25 (b "MulValue" 24 N N) N)
             (b "OrObs" 28 (b "Notify" 27 N N) N))
          (b "SubValue" 32
             (b "Role" 31 (b "Pay" 30 N N) N) (b "TimeIntervalEnd" 33 N N)))
       (b "ValueGE" 40
          (b "TrueObs" 37
             (b "Token" 36 (b "Timeout" 35 N N) N)
             (b "ValueEQ" 39 (b "UseValue" 38 N N) N))
          (b "ValueLT" 43
             (b "ValueLE" 42 (b "ValueGT" 41 N N) N) (b "When" 44 N N))))
  where
  b s n = B bs (TS bs n)
    where
    bs = s

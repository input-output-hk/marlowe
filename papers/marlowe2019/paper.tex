...
\section{Formal verification of semantics\label{sec:verification}}
...
\begin{itemize}
    ...
    \item It bounds the length of traces (the number of transactions) that symbolic execution (see Section~\ref{sec:static}) needs to explore (more on this below).
\end{itemize}
